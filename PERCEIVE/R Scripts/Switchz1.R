...
my.data_prune <- prune(my.data_rpart, cp = 5.5245e-03  )
print(my.data_prune)
plot(my.data_prune)
...
write.csv2(DEXfat_pred, "QSWITCHZ1predictedR1112.txt")
write.csv2(test$QSWITCHZ1, "QSWITCHZ1testR1112.txt")
