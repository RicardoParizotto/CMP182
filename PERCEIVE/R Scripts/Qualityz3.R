...
my.data_prune <- prune(my.data_rpart, cp = 1.9900e-04  )
print(my.data_prune)
plot(my.data_prune)
...
write.csv2(DEXfat_pred, "qualz3predictedR1112.txt")
write.csv2(test$QUALITYZ3, "qualz3testR1112.txt")
