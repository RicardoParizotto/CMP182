...
my.data_prune <- prune(my.data_rpart, cp = 6.7791e-04)
print(my.data_prune)
plot(my.data_prune)
...
write.csv2(DEXfat_pred, "QSWITCHZ2predictedR1112.txt")
write.csv2(test$QSWITCHZ2, "QSWITCHZ2testR1112.txt")
