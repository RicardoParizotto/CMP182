...
my.data_prune <- prune(my.data_rpart, cp = 1.6811e-03)
print(my.data_prune)
plot(my.data_prune)
...
write.csv2(DEXfat_pred, "QSWITCHZ3predictedR1112.txt")
write.csv2(test$QSWITCHZ3, "QSWITCHZ3testR1112.txt")
